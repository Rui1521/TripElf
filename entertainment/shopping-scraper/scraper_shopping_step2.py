...
def get_urls():
    shopping = pd.read_csv('shopping_no_dup_step1.csv')
    urls = shopping['yelpPage'].tolist()
    return urls
...
def crawl():
    ...
    print('\n**We are attempting to extract detailed shopping information in NYC!**')
    
    with open('./shopping_step2.csv', 'w') as shopping_more:
